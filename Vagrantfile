...
Vagrant::Config.run do |config|
  ...
  config.vm.box = "cbcsimple"
  #config.vm.box_url = "https://vagrantcloud.com/strets123/centos65/version/1/provider/centos-65.box"
  config.vm.box_url = "file:///home/astretton/vagrant_box_files/chembiocrunch.box"
