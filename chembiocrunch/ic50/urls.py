...
urlpatterns = [
    ...
    url(r'^(?P<pk>[0-9]+)/ic50visualisation_view/(?P<format>[a-zA-Z0-9]+)/(?P<marked_as_bad_fit>[a-zA-Z0-9]+)$', views.Ic50VisualisationView.as_view(), name='ic50_visualisation_view'),
